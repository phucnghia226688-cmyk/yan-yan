...
with open('src/components/AccountExpiredSuspendedView.tsx', 'r', encoding='utf-8') as f:
    content = f.read()
...
with open('src/components/AccountExpiredSuspendedView.tsx', 'w', encoding='utf-8') as f:
    f.write(content)
